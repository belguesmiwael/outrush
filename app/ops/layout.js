...
export default function OpsLayout({ children }) {
  return (
    <div className="min-h-dvh flex flex-col md:flex-row">
      <aside className="md:w-60 shrink-0 border-b md:border-b-0 md:border-r border-white/5 p-4 md:p-6 space-y-6" style={{ background: 'oklch(14% 0.015 260)' }}>
