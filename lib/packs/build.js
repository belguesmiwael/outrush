 ...
 * @param suggestedBy 'ai' (1-clic manuel) | 'ai_daily' (auto quotidien rotatif) | 'manual'
 */
export async function buildPackFromSuggestion(admin, sugg, { suggestedBy = 'ai', index = 0, composeImage = true } = {}) {
